...
INSERT INTO `chapter` VALUES (1,1,'Dirivatice',NULL,1,'2025-07-25 13:06:04','2025-07-25 13:06:04'),(2,1,'First degree equation',NULL,2,'2025-07-25 13:07:13','2025-07-25 13:07:13');
...
INSERT INTO `class` VALUES (1,'10A1','2025-08-04 14:38:34','2025-08-04 14:38:34'),(2,'11A1','2025-08-04 14:38:34','2025-08-04 14:38:34');
...
CREATE TABLE `exercise` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `create_by_teacher` (`created_by`),
  KEY `excercise_chapter` (`chapter_id`),
  CONSTRAINT `create_by_teacher` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `student_class` (
  ...
  CONSTRAINT `student_class_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`user_id`),
...
INSERT INTO `student_class` VALUES (4,1),(6,1),(5,2);
...
INSERT INTO `student_subject` VALUES (4,1),(5,1),(4,2);
...
INSERT INTO `subject` VALUES (1,'Math 10',NULL,'Include 10 chapter in year course','2025-07-31 14:30:46','2025-07-24 16:32:54'),(2,'History 10',NULL,'Learn about history of VietNam and World','2025-07-24 10:18:52','2025-07-24 16:30:51');
...
CREATE TABLE `teacher_class` (
  ...
  CONSTRAINT `teacher_class_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`user_id`),
...
INSERT INTO `teacher_class` VALUES (2,1),(3,1),(2,2);
...
INSERT INTO `teacher_subject` VALUES (2,1),(3,1),(2,2);
...
-- Dump completed on 2025-08-04 15:03:07
